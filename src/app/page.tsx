...
<h1 className="font-Inter font-semibold text-[23px] lg:text-[48px] text-white text-centre absolute top-[83px] lg:top-[130px] lg:ml-[160px]">Bite into adventure, get GreenBite delivered. </h1>
...
<p className="pt-3 lg:px-8 font-Inter font-semibold text-[17px] text-white lg:text-xl  absolute top-[153px] lg:top-[240px] lg:ml-[290px] lg:w-[830px]">
  Explore a world of organic flavors and skip the supermarket, embrace the wild so that you can experience fresh and organic goodness delivered to your doorstep.</p>
  <div className="flex items-center justify-center left-[50px] lg:min-w-fit py-4 absolute top-[310px] lg:left-[520px]">
    ...
    <p className="font-Inter italic text-white absolute top-[410px]
    lg:top-[560px] lg:left-96">"When you buy organic, you're not just feeding your body, you're feeding the health of the planet." - Vishnu Thirumalai</p>
</div>
<div  className="w-full h-16 md:h-20 bg-cover bg-center mt-28"
      ...
      />
        ...
        <div  className=" mt-11 ml-5"><QuoteCard 
